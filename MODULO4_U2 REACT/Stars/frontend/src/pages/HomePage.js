...
const HomePage = (props) => {
   return (  
    ...
    <div class="holder">
        <img class="logo" src="public/images/logo.png" alt="Logo"> </img>
    ...
    <div class="homeimg">
           ...
           <img src="public/images/Rocket.jpg" height="250px" width="960px" alt="Map"> </img>
         </div>
         <div class="columnas">
    ...
    <div class="Index_img">
       ...
       <div class="images">
           <div class="image">
        <img src="public/images/home/Galaxy_1.jpg" width="150" height="150" alt="Galaxy_1"> </img>
         <h5>Sail of Stars</h5>
       ...
       <div class="image">
        <img src="public/images/home/Galaxy_2.jpg" width="150" height="150" alt="Galaxy_2"> </img>
         ...
         <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem totam quibusdam consequuntur at neque ab, tenetur nesciunt in quo obcaecati, accusantium minus aut, fugiat veritatis eum nemo consectetur enim ex.</p>
          ...
          <div class="image">
      <img src="public/images/home/Galaxy_3.jpg" width="150" height="150" alt="Galaxy_3"> </img>
        <h5>Galactic Duo</h5>
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem totam quibusdam consequuntur at neque ab, tenetur nesciunt in quo obcaecati, accusantium minus aut, fugiat veritatis eum nemo consectetur enim ex.</p>
         ...
         <div class="image">
       <img src="public/images/home/Galaxy_4.jpg" width="150" height="150" alt="Galaxy_4"> </img>
   ...
   <div class="image">
    <img src="public/images/home/Galaxy_5.jpg" width="150" height="150" alt="Galaxy_5"> </img>
